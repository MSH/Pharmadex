...
@ManagedBean
@RequestScoped
public class ProdConsentFormBg extends ProdConsentFormMZ implements Serializable {

    java.util.ResourceBundle bundle;
    private FacesContext context;
     @ManagedProperty(value = "#{prodApplicationsServiceAdd}")
    private ProdApplicationsServiceAdd prodApplicationsServiceAdd;

    @Override
    public String submitApp() {
    	ProdApplications curA=getProdApplications();
    	curA.setProdAppNo(prodApplicationsServiceAdd.generateAppNo(getProdApplications()));
	...
	public void setProdApplicationsServiceAdd(ProdApplicationsServiceAdd prodApplicationsServiceAdd) {
		this.prodApplicationsServiceAdd = prodApplicationsServiceAdd;
	}
