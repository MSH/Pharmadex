...
@ManagedBean
@RequestScoped
public class ProdConsentFormBN implements Serializable {
    ...
    private ProdApplicationsServiceBN prodApplicationsServiceBN;
...
//        StreamedContent download = new DefaultStreamedContent(ist, "image/jpg", "After3.jpg");
    ...
    public String submitApp() {
        ...
        if (retObject.getMsg().equals("persist")) {
            ...
            prodApplicationsServiceBN.createAckLetter(prodApplications);
            timeLine.setProdApplications(prodApplications);
