...
public class ReviewDetailPrintMZ implements Serializable {
	...
	public static JRMapArrayDataSource createReviewSourcePorto(ProdApplications prodApplications, ResourceBundle bun, Properties prop, ProductCompanyDAO prodCompanyDAO,
		...
		//fillResolutionText(res, prop, reviewInfoDAO); // TODO
	...
	private static void fillGeneralRS(List<Map<String, Object>> res, Properties prop, ProductCompanyDAO prodCompanyDAO) {
		if (prop.getProperty("chapter1_1") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_1"), fetchFullApplicant(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_2") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_2"),
					prodApp.getProduct().getGenName(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_3") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_3"),
					prodApp.getProduct().getProdName(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_4") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_4"), fetchFullDosStrength(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_5") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_5"), fetchExcipients(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_6") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_6"),
					prodApp.getProduct().getPackSize(), null,null,null,null,null,null,null);
		if (prop.getProperty("chapter1_7") != null)
			fillItemRS(res, prop.getProperty("chapter1"), prop.getProperty("chapter1_7"),
					prodApp.getProduct().getDosForm().getDosForm(), null,null,null,null,null,null,null);
	...
	private static void fillGeneralText(List<Map<String, Object>> res, Properties prop, ProductCompanyDAO prodCompanyDAO) {
		...
		if(prop.getProperty("chapter2")!=null){
			...
			fillItemRS(res,prop.getProperty("chapter2"),null,chapter2t,null,null,null,null,null,null,null);//TODO
	...
	private static void fillResolutionText(List<Map<String, Object>> res, Properties prop, ReviewInfoDAO reviewInfoDAO) {
		...
		fillItemRS(res, prop.getProperty("chapter3"), null, text, null, null, null, null, null,null,null);
	}
...
/*				Collections.sort(list, new Comparator<ReviewItemReport>() {
	...
	private static void printItemReview(List<Map<String, Object>> res, String chapter1, ReviewItemReport item){
		...
		if(!text.isEmpty() || file != null){
			 ...
			 String no_reason = item.getNo_reason();
			 String answer = item.getAnswer();
			 fillItemRS(res, chapter1, null, text, file,pages,reviewItemHead,reviewQuestion, textRev,no_reason, answer);
		}
	}
	...
	private static void fillItemRS(List<Map<String, Object>> res, String reviewChapter, String reviewItem,
				...
				String no_reason, String answer){
		...
		//map.put(UtilsByReports.KEY_EXECSUMMARY, "execsumary");
		res.add(map);
	}
	/*private static void fillItemRDR(List<Map<String, Object>> res){

	Map<String,Object> map = new HashMap<String,Object>();		
	map.put("reviewChapter",null);
	map.put("reviewItem",null);
	map.put("pagesItem",null);
	map.put("reviewItemHead",null);		
	map.put("reviewItemData",null);	
	map.put("reviewConclusionData", null);
	map.put("reviewItemFile",null);		
	map.put("reviewQuestion",null);		
	map.put("no_reason", null);
	map.put("answer", null);
	map.put(UtilsByReports.KEY_EXECSUMMARY, "execsumary");
	res.add(map);
}*/
