...
@Service
@Transactional
public class ProdApplicationsServiceBN implements Serializable {

	private static final long serialVersionUID = -7839454808850487273L;
	...
	@Autowired
	private UtilsByReportsBN utilsByReports;
	...
	public String createRegCert(ProdApplications prodApp, String gestorDeCTRM) throws IOException, JRException, SQLException {
		...
		// 20.07.2016 We are waiting for templates	
	...
	public JasperPrint initRegCert(String gestor) throws JRException, SQLException {
		...
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_APPNUMBER, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_REG_NUMBER, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_SUBMIT_DATE, "", false);

		utilsByReports.putNotNull(UtilsByReportsBN.KEY_PRODNAME, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_APPNAME, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_ADDRESS1, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_MANUFNAME, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_SHELFINE, "", false);

		//inn
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_INN, "", false);

		utilsByReports.putNotNull(UtilsByReportsBN.KEY_PRODSTRENGTH, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_DOSFORM, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_PACKSIZE, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_STORAGE, "", false);
		//excipient
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_EXCIPIENT, "", false);

		String fnm = (product != null) ? product.getFnm():"";
		boolean flag = (fnm != null && fnm.length() > 0) ? true: false;
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_FNM, flag);
		...
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_APPTYPE, t);
		...
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_DRUGTYPE, t);
		...
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_SUBACT, fl);

		fl = false;
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_GEN, fl);

		utilsByReports.putNotNull(UtilsByReportsBN.KEY_REG_DATE, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_EXPIRY_DATE, "", false);
		utilsByReports.putNotNull(UtilsByReportsBN.KEY_GESTOR, gestor);
	...
	public String createAckLetter(ProdApplications prodApp) {
		...
		try {
			...
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_APPNAME, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_DOSREC_DATE, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_PRODNAME, "", false);

			utilsByReports.putNotNull(UtilsByReportsBN.KEY_GENNAME, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_PRODSTRENGTH, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_DOSFORM, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_PACKSIZE, "", false);
			utilsByReports.putNotNull(UtilsByReportsBN.KEY_MANUFNAME, "", false);
