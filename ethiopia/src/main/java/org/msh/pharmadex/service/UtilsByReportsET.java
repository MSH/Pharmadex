 ...
 */
@Component
public class UtilsByReportsET implements Serializable {
	...
	public static String KEY_COMPANY_TYPE = "companyType";
	...
	public static String KEY_LICH_NAME = "licH_name";
	public static String KEY_LICH_ADDRESS="licH_address";
	public static String KEY_INDICATION ="indications";
	public static String KEY_CONTTYPE ="contType";
